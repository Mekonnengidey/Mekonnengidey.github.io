...
header:
  teaser: "/images/study-area-map.png"
categories:
  - Portfolio
  - Remote Sensing
tags:
...
![Awash River study area and baseline conditions](/images/study-area-map.png)
...
![Google Earth Engine code editor and initial script output](/images/gee-code-editor.png)
...
![Bimodal histogram showing the -12 dB backscatter threshold](/images/bimodal-histogram.png)
...
![Side-by-side comparison of final flood extraction masks from SNAP and GEE](/images/snap-vs-gee-comparison.png)
