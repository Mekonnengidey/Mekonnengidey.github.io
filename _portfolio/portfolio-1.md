...
![Map showing the Awash River study area and baseline conditions](/images/500x300.png)
...
*   **Geometric Adjustments:** Executed Range-Doppler Terrain Correction using an SRTM Digital Elevation Model to project radar geometry onto a flat WGS84 Cartesian grid at a 10-meter spatial resolution.
 ...
 [ ESA SNAP Graph Builder showing the pre-processing node chain](/assets/images/portfolio/snap-graph-workflow.png)

![Screenshot of the ESA SNAP Graph Builder showing the pre-processing node chain](/images/500x300.png)
...
![Screenshot of the Google Earth Engine code editor and initial script output](/images/500x300.png)
...
![Bimodal histogram graph demonstrating the -12 dB backscatter threshold cut-off](/images/500x300.png)
...
![Side-by-side comparison maps of the final flood extraction masks: SNAP vs. GEE](/images/500x300.png)
