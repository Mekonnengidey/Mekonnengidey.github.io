...
**Email:** [mekonnengidey@gmail.com](mailto:mekonnengidey@gmail.com) · [mekonnen.gidey@bdu.edu.et](mailto:mekonnen.gidey@bdu.edu.et)
...
**GitHub:** [github.com/Mekonnengidey](https://github.com/Mekonnengidey)
...
* Develop **technical manuals, datasets, laboratory exercises, and research-oriented teaching resources** for undergraduate and postgraduate training.
...
* Contribute to faculty and institutional research through **geospatial data acquisition, database development, remote-sensing analysis, spatial modeling, and research documentation**.
...
* **Pandikumar, T., & Gidey, M. (2017).** *Data Security in LAN Using Distributed Firewall.* **International Research Journal of Engineering and Technology (IRJET), 4(5), 867–873.**
  [Publication record](https://doi.org/10.13140/RG.2.2.27418.09924)
...
| -------------------------------------------- | ------------------------------------------------------------------ |
| **SAR Data Processing & Applications**       | Sentinel-1, SAR preprocessing, calibration, filtering, backscatter |
| **Sentinel-1 Flood Monitoring**              | VV/VH, change detection, thresholding, flood mapping               |
| **InSAR Surface Deformation**                | InSAR, interferometry, phase analysis, deformation                 |
| **Object-Based Image Classification**        | OBIA, segmentation, Bayesian classification                        |
| **Watershed & Morphometric Analysis**        | DEM, hydrology, morphometry, prioritization                        |
| **Investment Site Suitability**              | Geostatistics, MCDA, suitability analysis                          |
...
**Git · GitHub · GitLab · REST APIs · HTML/CSS · JavaScript · Agile/Scrum**
...
* **NASA ARSET — NISAR Training:** Completed training focused on the NISAR mission and applications of SAR Earth observation.
* Advanced training and practical development in **SAR/InSAR, Google Earth Engine, geospatial machine learning, spatial data science, and cloud-based Earth observation workflows**.
